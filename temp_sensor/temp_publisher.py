...
class TempPublisher:
    ...
    async def publish_temp_loop(self):
        while True:
            ...
            if (self._last_publish_time is None or current_time >= self._next_publish_time) and current_temperature is not None and self._interval is not None and is_wifi_connected:
                try:
